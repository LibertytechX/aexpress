"""Integration tests for Subscription lifecycle, usage tracking, and invoice generation."""
...
from subscriptions.services import (
    generate_end_of_period_invoice,
...
class SubscriptionTestCase(TestCase):
    """Integration test suite for merchant subscription workflows."""
    ...
    def test_usage_tracking_and_overage(self):
        ...
        order1 = Order.objects.create(
            user=self.user, vehicle=self.vehicle, total_amount=Decimal("500.00")
        )
