...
class VehicleDistanceTelemetryTests(TestCase):
    def test_extract_total_distance_supports_multiple_keys(self):
        from dispatcher.management.commands.sync_bike_telemetry import _extract_total_distance
    ...
    def test_build_tracking_row_skips_invalid_coords_and_requires_travelled(self):
        ...
        from dispatcher.management.commands.sync_bike_telemetry import _build_tracking_row
    ...
    def test_upsert_device_does_not_overwrite_distance_when_provider_omits(self):
        from dispatcher.models import VehicleAsset
        from dispatcher.management.commands.sync_bike_telemetry import _upsert_device
...
class RiderAdminLookupTests(TestCase):
    def setUp(self):
        from authentication.models import User
        from dispatcher.admin import RiderAdmin
        from dispatcher.models import Rider
