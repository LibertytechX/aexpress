    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usertype', models.CharField(choices=[('Merchant', 'Merchant'), ('Rider', 'Rider'), ('Customer', 'Customer'), ('Dispatcher', 'Dispatcher')], default='Merchant', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('label', models.CharField(help_text='e.g., Office, Warehouse, Home', max_length=100)),
