...
from .views import (
    ...
    RiderDocumentListCreateView,
    RiderDocumentDetailView,
)
...
urlpatterns = [
    ...
    path(
        "documents/",
        RiderDocumentListCreateView.as_view(),
        name="rider-document-list-create",
    ),
    path(
        "documents/<uuid:pk>/",
        RiderDocumentDetailView.as_view(),
        name="rider-document-detail",
    ),
    # ── Gamification ─────────────────────────────────────────────────────────
