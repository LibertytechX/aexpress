...
const S = {
  ...
  navyLight: "#3E4C70",
  gold: "#FBB12F", // Primary Action / Accents
  goldLight: "#FDCB6E",
  goldPale: "#FFF8E1",
  green: "#00B67A", // Success / Secondary Accent
  greenBg: "#E0F7EF",
  red: "#EF4444",
  redBg: "#FEE2E2",
  white: "#ffffff",
...
export default function DashboardPage() {
  ...
  const handleResendVerification = async () => {
    try {
      const accessToken = API?.Token?.getAccessToken();
  ...
  return (
    <div className='flex h-screen w-full bg-[#2F3758] p-2 gap-2 overflow-hidden font-sans'>
        ...
        <FundWalletModal
          ...
          onFund={async (amount) => {
            try {
              ...
              const keyResponse = await API.Wallet.getPaystackKey();
              ...
              // Initialize payment
              const response = await API.Wallet.initializePayment(amount);
              ...
              if (response.success) {
                ...
                const handler = window.PaystackPop.setup({
                  ...
                  callback: async function (response) {
                    // Payment successful
                    try {
                      const verifyResponse = await API.Wallet.verifyPayment(reference);
          ...
          <div style={{ padding: 20, marginTop: "auto" }}>
            <div style={{
              ...
              <div style={{ position: "relative", zIndex: 10 }}>
                <div style={{ width: 32, height: 32, borderRadius: "50%", background: "rgba(255,255,255,0.1)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 12, color: "#fff" }}>
                  {Icons.bike}
                </div>
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-[#F8FAFC] md:rounded-[30px] shadow-2xl overflow-hidden relative">
        ...
        {/* Page Content */}
        <div className="no-scrollbar" style={{ flex: 1, padding: "24px", overflowY: "auto" }}>
          {screen === "dashboard" && (
            <DashboardScreen
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", gap: 32, marginTop: 48 }}>
            {[{ n: "40+", l: "Active Riders" }, { n: "21min", l: "Avg Delivery" }, { n: "₦1.2K", l: "From" }].map((s, i) => (
              <div key={i}>
                <div style={{ color: "#E8A838", fontSize: 28, fontWeight: 700 }}>{s.n}</div>
      ...
      <div style={{ width: 480, background: "#fff", display: "flex", flexDirection: "column", justifyContent: "center", padding: "60px" }}>
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", border: "1.5px solid #e2e8f0", borderRadius: 10, overflow: "hidden" }}>
            ...
            <input value={phone} onChange={e => setPhone(e.target.value)} onKeyPress={handleKeyPress} placeholder="8099999999"
              style={{ flex: 1, border: "none", padding: "0 14px", height: 46, fontSize: 15, fontFamily: "inherit", background: "transparent", color: "#1B2A4A", fontWeight: 600 }} />
          </div>
        </div>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <input type="password" value={pass} onChange={e => setPass(e.target.value)} onKeyPress={handleKeyPress} placeholder="Enter password"
            style={{ width: "100%", border: "1.5px solid #e2e8f0", borderRadius: 10, padding: "0 14px", height: 46, fontSize: 15, fontFamily: "inherit", color: "#1B2A4A", fontWeight: 600 }} />
        </div>
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex" }}>
      ...
      <div style={{ flex: 1, background: "linear-gradient(145deg, #1B2A4A, #0f1b33)", display: "flex", alignItems: "center", justifyContent: "center", padding: 60 }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 48 }}>
            <div style={{ width: 44, height: 44, borderRadius: 10, background: "linear-gradient(135deg, #E8A838, #F5C563)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800, fontSize: 18, color: "#1B2A4A" }}>AX</div>
            <div>
        ...
        {step === 1 && (
          <>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@business.com" style={{ width: "100%", border: "1.5px solid #e2e8f0", borderRadius: 10, padding: "0 14px", height: 44, fontSize: 14, fontFamily: "inherit", color: "#1B2A4A", fontWeight: 600 }} />
            </div>
            <div style={{ marginBottom: 16 }}>
              <label style={{ display: "block", fontSize: 13, fontWeight: 600, color: "#334155", marginBottom: 6 }}>Password</label>
              <input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Min. 8 characters" style={{ width: "100%", border: "1.5px solid #e2e8f0", borderRadius: 10, padding: "0 14px", height: 44, fontSize: 14, fontFamily: "inherit", color: "#1B2A4A", fontWeight: 600 }} />
            </div>
            <div style={{ marginBottom: 16 }}>
              <label style={{ display: "block", fontSize: 13, fontWeight: 600, color: "#334155", marginBottom: 6 }}>Confirm Password</label>
              <input
        ...
        {step === 2 && (
          <>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <input value={businessName} onChange={e => setBusinessName(e.target.value)} placeholder="Vivid Print" style={{ width: "100%", border: "1.5px solid #e2e8f0", borderRadius: 10, padding: "0 14px", height: 44, fontSize: 14, fontFamily: "inherit", color: "#1B2A4A", fontWeight: 600 }} />
            </div>
            <div style={{ marginBottom: 16 }}>
              <label style={{ display: "block", fontSize: 13, fontWeight: 600, color: "#334155", marginBottom: 6 }}>Business Address</label>
              <input value={address} onChange={e => setAddress(e.target.value)} placeholder="19 Tejuosho Street, Yaba" style={{ width: "100%", border: "1.5px solid #e2e8f0", borderRadius: 10, padding: "0 14px", height: 44, fontSize: 14, fontFamily: "inherit", color: "#1B2A4A", fontWeight: 600 }} />
            </div>
...
function DashboardScreen({ balance, orders, onNewOrder, onFund, onViewOrder, onGoOrders, currentUser, onResendVerification }) {
  ...
  const cards = [
    { label: "Wallet Balance", value: `₦${balance.toLocaleString()}`, sub: "Available funds", bg: S.navy, color: "#fff", icon: Icons.wallet, action: "Fund", onAction: onFund },
    { label: "Orders This Month", value: orders.length.toString(), sub: `${delivered} delivered`, bg: "#fff", color: S.navy, icon: Icons.bike },
  ...
  return (
    <div style={{ flex: 1, minWidth: 0, minHeight: 520, borderRadius: 14, overflow: "hidden", position: "relative", border: "1px solid #e2e8f0" }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 18, fontWeight: 800, color: S.navy }}>₦{totalCost.toLocaleString()}</div>
      </div>
...
function NewOrderScreen({ balance, onPlaceOrder, currentUser }) {
  ...
  const handleFileUpload = (e) => {
    ...
    if (file.type.startsWith("image/")) {
      ...
      reader.onload = (ev) => {
        ...
        setBulkText(text as string);
        setBulkRows(parseBulkText(text as string));
      };
  ...
  // ─── Shared input style ───
  const inputStyle = { width: "100%", border: "1.5px solid #e2e8f0", borderRadius: 10, padding: "0 14px", height: 42, fontSize: 14, fontFamily: "inherit", color: "#1e293b", fontWeight: 600 };
                ...
                <>
                  <textarea
                    ...
                    style={{
                      ...
                      fontSize: 13, minHeight: 140, resize: "vertical",
                    ...
                    {bulkRows.map((row, idx) => (
                      <div key={row.id} style={{
                        ...
                        <input value={row.phone} onChange={e => updateBulkRow(row.id, "phone", e.target.value)}
                          style={{ border: "none", fontSize: 13, color: S.navy, fontWeight: 600, background: "transparent", width: "100%" }} />
                        <select value={row.pkg || "Box"} onChange={e => updateBulkRow(row.id, "pkg", e.target.value)}
                          style={{ border: "none", fontSize: 11, background: "transparent", cursor: "pointer", fontFamily: "inherit", color: S.navy, fontWeight: 600 }}>
                          {pkgTypes.map(p => <option key={p} value={p}>{p}</option>)}
                        </select>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #e2e8f0", padding: 20, marginBottom: 14 }}>
              ...
              <div style={{
                ...
                <span style={{ fontSize: 22, fontWeight: 800, color: S.navy }}>
        ...
        <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #e2e8f0", overflow: "hidden" }}>
          <div style={{ padding: "20px 24px", borderBottom: "1px solid #f1f5f9", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div>
              ...
              <div style={{ fontSize: 20, fontWeight: 800, color: S.navy }}>#{order.id}</div>
              {order.mode && (() => {
                const modeBadge = getModeBadge(order.mode);
                return (
              ...
              {order.rider_name && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className=""><circle cx="18.5" cy="17.5" r="3.5"></circle><circle cx="5.5" cy="17.5" r="3.5"></circle><circle cx="15" cy="5" r="1"></circle><path d="M12 17.5V14l-3-3 4-3 2 3h2" className=""></path></svg>
                  </div>
    ...
    <div style={{ animation: "fadeIn 0.3s ease" }}>
      ...
      <div style={{
        ...
        <div style={{ position: "relative" }}>
          ...
          <div style={{ fontSize: 38, fontWeight: 800, color: "#fff", marginTop: 8 }}>₦{balance.toLocaleString()}</div>
      ...
      <div style={{ position: "relative", background: "#fff", borderRadius: 18, width: 420, maxHeight: "90vh", overflow: "auto", boxShadow: "0 20px 60px rgba(0,0,0,0.2)", animation: "fadeIn 0.3s ease" }}>
        ...
        <div style={{ padding: 24 }}>
          ...
          <input value={amount} onChange={e => setAmount(e.target.value.replace(/[^0-9]/g, ""))} placeholder="Enter amount"
            style={{ width: "100%", border: "1.5px solid #e2e8f0", borderRadius: 10, padding: "0 14px", height: 48, fontSize: 20, fontWeight: 700, textAlign: "center", color: S.navy }} />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8, marginTop: 12 }}>
            {presets.map(p => (
              <button key={p} onClick={() => setAmount(p.toString())} style={{
                ...
                fontSize: 14, fontWeight: 600, color: S.navy
...
function SettingsScreen({ currentUser, onUpdateUser, onShowNotif }) {
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      if (response.success) {
        // Update user in localStorage
        API.Token.setUser(response.user);
  ...
  const handleSaveAddress = async () => {
    ...
    try {
      ...
      let response;
      if (editingAddress) {
        response = await API.Auth.updateAddress(editingAddress.id, addressData);
      } else {
        response = await API.Auth.createAddress(addressData);
      }
  ...
  const handleSetDefault = async (addressId) => {
    try {
      setLoading(true);
      const response = await API.Auth.setDefaultAddress(addressId);
      if (response.success) {
        await loadAddresses();
        if (onShowNotif) {
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          {demoSites.map(site => (
            <div key={site.id} onClick={() => setSelectedSite(site)} style={{
              ...
              <div style={{ fontSize: 12, color: S.gold, fontWeight: 600, marginBottom: 14 }}>
                🔗 {site.domain}
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8 }}>
                {[
                  ...
                  <div key={s.label} style={{ textAlign: "center", padding: "8px 0", background: "#f8fafc", borderRadius: 8 }}>
                    <div style={{ fontSize: 16, fontWeight: 800, color: S.navy }}>{s.value}</div>
            ...
            {demoProducts.map((p, i) => (
              <div key={i} style={{ background: "#fff", borderRadius: 12, border: "1px solid #e2e8f0", padding: 16, transition: "all 0.2s" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 8 }}>
                  <div style={{ fontSize: 15, fontWeight: 800, color: S.navy }}>₦{p.price.toLocaleString()}</div>
              ...
              <div key={order.id} style={{
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
                    <span style={{ fontWeight: 800, color: S.navy, fontSize: 14 }}>{order.id}</span>
                ...
                <div style={{ textAlign: "right" }}>
                  <div style={{ fontSize: 16, fontWeight: 800, color: S.navy }}>₦{order.total.toLocaleString()}</div>
        ...
        <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #e2e8f0", overflow: "hidden" }}>
          ...
          {webTransactions.map(tx => (
            <div key={tx.id} style={{
              ...
              <span style={{ fontSize: 12, color: S.grayLight }}>{tx.id}</span>
              <span style={{ fontSize: 12, fontWeight: 700, color: S.navy }}>{tx.order}</span>
              <span style={{ fontSize: 13, color: S.navy }}>{tx.customer}</span>
              <span style={{ fontSize: 13, fontWeight: 700, color: S.navy }}>₦{tx.amount.toLocaleString()}</span>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "300px 1fr", gap: 20 }}>
            ...
            {[
              ...
              <div key={f.label} style={{ marginBottom: 12 }}>
                ...
                <input defaultValue={f.value} style={{
                  width: "100%", border: "1.5px solid #e2e8f0", borderRadius: 8, padding: "0 12px", height: 38, fontSize: 13, fontFamily: "inherit", color: "#1B2A4A", fontWeight: 600
                }} />
              </div>
            ))}
          ...
          <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #e2e8f0", overflow: "hidden" }}>
            <div style={{ padding: "10px 16px", background: "#f8fafc", borderBottom: "1px solid #e2e8f0", display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <div style={{ flex: 1, background: "#fff", borderRadius: 6, padding: "5px 12px", fontSize: 11, color: S.grayLight }}>
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            {["Store Name", "Subdomain", "Business Category", "WhatsApp Number"].map((f, i) => (
              <div key={f} style={{ marginBottom: 14 }}>
                ...
                {f === "Subdomain" ? (
                  <div style={{ display: "flex", border: "1.5px solid #e2e8f0", borderRadius: 10, overflow: "hidden" }}>
                    <input placeholder="yourstore" style={{ flex: 1, border: "none", padding: "0 12px", height: 40, fontSize: 13, fontFamily: "inherit", color: "#1B2A4A", fontWeight: 600 }} />
                    <span style={{ padding: "0 12px", background: "#f8fafc", borderLeft: "1px solid #e2e8f0", display: "flex", alignItems: "center", fontSize: 12, color: S.grayLight }}>.axpress.shop</span>
                  </div>
                ) : f === "Business Category" ? (
                  <select style={{ width: "100%", border: "1.5px solid #e2e8f0", borderRadius: 10, padding: "0 12px", height: 40, fontSize: 13, fontFamily: "inherit", background: "#fff", color: "#1B2A4A", fontWeight: 600 }}>
                  ...
                  <input placeholder={f === "Store Name" ? "e.g. Vivid Print" : "e.g. 08051832508"} style={{
                    width: "100%", border: "1.5px solid #e2e8f0", borderRadius: 10, padding: "0 12px", height: 40, fontSize: 13, fontFamily: "inherit", color: "#1B2A4A", fontWeight: 600
                  }} />
                )}
              </div>
            ))}
            ...
            {[
              ...
              <div key={s.label} style={{ background: "#fff", borderRadius: 12, border: "1px solid #e2e8f0", padding: 16, display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 20, fontWeight: 800, color: S.navy }}>{s.value}</div>
            ...
            <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #e2e8f0", padding: 20 }}>
              ...
              {salesHistory.slice(0, 6).map(sale => (
                <div key={sale.id} style={{
                  ...
                  <div style={{ fontSize: 14, fontWeight: 800, color: S.navy }}>₦{sale.total.toLocaleString()}</div>
                </div>
              ))}
            </div>
                ...
                {revenueByBranch.map(b => (
                  <div key={b.branch} style={{ marginBottom: 12 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                      ...
                      <span style={{ fontSize: 13, fontWeight: 700, color: S.navy }}>₦{(b.revenue / 1000).toFixed(0)}K</span>
                    </div>
              ...
              <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #e2e8f0", padding: 20 }}>
                ...
                {staff.filter(s => s.sales > 0).sort((a, b) => b.revenue - a.revenue).slice(0, 4).map((s, i) => (
                  <div key={s.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 0", borderBottom: i < 3 ? "1px solid #f8fafc" : "none" }}>
                    ...
                    <div style={{ fontSize: 13, fontWeight: 700, color: S.navy }}>₦{(s.revenue / 1000).toFixed(0)}K</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #e2e8f0", overflow: "hidden" }}>
            ...
            {salesHistory.map(sale => (
              <div key={sale.id} style={{
                ...
                <span style={{ fontSize: 12, fontWeight: 700, color: S.navy }}>{sale.id}</span>
                <span style={{
                ...
                <span style={{ fontSize: 13, fontWeight: 700, color: S.navy }}>₦{sale.total.toLocaleString()}</span>
            ...
            {staff.map(s => (
              <div key={s.id} style={{
                ...
                <div style={{ textAlign: "right", minWidth: 100 }}>
                  {s.sales > 0 ? (
                    <>
                      <div style={{ fontSize: 14, fontWeight: 800, color: S.navy }}>₦{(s.revenue / 1000).toFixed(0)}K</div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 14 }}>
                  {[
                    ...
                    <div key={s.label} style={{ padding: "8px 10px", background: "#f8fafc", borderRadius: 8 }}>
                      <div style={{ fontSize: 15, fontWeight: 800, color: S.navy }}>{s.value}</div>
                      <div style={{ fontSize: 10, color: S.grayLight }}>{s.label}</div>
                    </div>
                  ))}
                </div>
              ...
              {section.fields && section.fields.map(f => (
                <div key={f.label} style={{ marginBottom: 12 }}>
                  ...
                  <input defaultValue={f.value} style={{
                    ...
                    height: 38, fontSize: 14, color: S.navy, fontWeight: 600
                  }} />
      ...
      {showAddStaff && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000 }}
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            {[
              ...
              <div key={f.label} style={{ marginBottom: 14 }}>
                ...
                <input placeholder={f.placeholder} type={f.type || "text"} style={{
                  ...
                  height: 42, fontSize: 13, fontFamily: "inherit", color: S.navy, fontWeight: 600
                }} />
              </div>
            ))}
            ...
            <select style={{
              width: "100%", border: "1.5px solid #e2e8f0", borderRadius: 10, padding: "0 12px",
              height: 42, fontSize: 13, fontFamily: "inherit", background: "#fff", marginBottom: 18, color: S.navy, fontWeight: 600
            }}>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000 }}
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            {[
              ...
              <div key={f.label} style={{ marginBottom: 14 }}>
                ...
                <input placeholder={f.placeholder} style={{
                  width: "100%", border: "1.5px solid #e2e8f0", borderRadius: 10, padding: "0 12px", height: 42, fontSize: 13, fontFamily: "inherit", color: "#1B2A4A", fontWeight: 600
                }} />
              </div>
            ))}
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <div style={{ display: "flex", border: "1.5px solid #e2e8f0", borderRadius: 10, overflow: "hidden" }}>
                <input placeholder="liberty-vi" style={{ flex: 1, border: "none", padding: "0 12px", height: 40, fontSize: 13, fontFamily: "inherit", color: "#1B2A4A", fontWeight: 600 }} />
                <span style={{ padding: "0 12px", background: "#f8fafc", borderLeft: "1px solid #e2e8f0", display: "flex", alignItems: "center", fontSize: 12, color: S.grayLight }}>.paybox360.com</span>
              </div>
            </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: 20, fontWeight: 800, color: S.navy, lineHeight: 1 }}>720</div>
                ...
                <div style={{ background: "#f8fafc", borderRadius: 12, padding: 16 }}>
                  ...
                  {selected.id === "invoicing" && selected.preview.map((inv, i) => (
                    <div key={i} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 0", borderBottom: i < 2 ? "1px solid #e2e8f0" : "none" }}>
                      <div>
                        <span style={{ fontSize: 12, fontWeight: 700, color: S.navy }}>{inv.label}</span>
                        <span style={{ fontSize: 12, color: S.grayLight, marginLeft: 8 }}>{inv.customer}</span>
                      </div>
                      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                        <span style={{ fontSize: 13, fontWeight: 700, color: S.navy }}>{inv.amount}</span>
                  ...
                  {selected.id === "expenses" && selected.preview.map((exp, i) => (
                    <div key={i} style={{ marginBottom: 10 }}>
                      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 3 }}>
                        ...
                        <span style={{ fontSize: 12, fontWeight: 700, color: S.navy }}>{exp.amount}</span>
                      </div>
                  ...
                  {selected.id === "pnl" && selected.preview.map((row, i) => (
                    <div key={i} style={{
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                        <span style={{ fontSize: 14, fontWeight: 700, color: S.navy }}>{row.value}</span>
                  ...
                  {selected.id === "tax" && selected.preview.map((t, i) => (
                    <div key={i} style={{
                      ...
                      <span style={{ fontSize: 14, fontWeight: 700, color: S.navy }}>{t.amount}</span>
                    </div>
                  ))}
                  ...
                  {selected.id === "payroll" && selected.preview.map((p, i) => (
                    <div key={i} style={{
                      ...
                      <div style={{ textAlign: "right" }}>
                        <div style={{ fontSize: 16, fontWeight: 800, color: S.navy }}>{p.amount}</div>
