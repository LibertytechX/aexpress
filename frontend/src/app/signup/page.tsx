            ...
            <div style={{ width: 480, background: "#fff", display: "flex", flexDirection: "column", justifyContent: "center", padding: 60 }}>
                ...
                {step === 3 && (
                    <>
                        ...
                        <button onClick={() => router.push('/dashboard')} style={{ width: "100%", height: 46, border: "none", borderRadius: 10, fontSize: 15, fontWeight: 700, cursor: "pointer", background: "linear-gradient(135deg, #E8A838, #F5C563)", color: "#1B2A4A", fontFamily: "inherit" }}>
                            Go to Dashboard
                        </button>
                    </>
                )}
                {step < 3 && (
                    <div style={{ textAlign: "center", marginTop: 20 }}>
                        ...
                        <Link href="/login" style={{ color: "#E8A838", fontWeight: 700, cursor: "pointer", fontSize: 14, fontFamily: "inherit", textDecoration: "none" }}>Sign In</Link>
                    </div>
                )}
            </div>
        </div>
